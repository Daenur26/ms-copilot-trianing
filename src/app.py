...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, work on technique, and prepare for meets",
    ...
    "Drama Club": {
        "description": "Practice acting, stagecraft, and perform in school plays",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Train on challenging math problems and compete in contests",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 12,
